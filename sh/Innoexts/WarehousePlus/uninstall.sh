...
rm -fr $CWD/app/code/local/Innoexts/WarehousePlus/
rm -f $CWD/app/design/adminhtml/default/default/layout/warehouseplus.xml
rm -fr $CWD/app/design/adminhtml/default/default/template/warehouseplus/
rm -f $CWD/app/etc/modules/Innoexts_WarehousePlus.xml
rm -f $CWD/app/locale/en_US/Innoexts_WarehousePlus.csv
rm -fr $CWD/shell/Innoexts/WarehousePlus/
rm -fr $CWD/skin/adminhtml/default/default/warehouseplus/
rm -fr $CWD/sql/Innoexts/WarehousePlus/
rm -fr $CWD/var/import/Innoexts/WarehousePlus/
rm -f $CWD/var/connect/Innoexts_WarehousePlus.xml