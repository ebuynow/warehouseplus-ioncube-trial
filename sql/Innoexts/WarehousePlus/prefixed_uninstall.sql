...
ALTER TABLE `[prefix]_catalog_product_index_price` DROP INDEX IDX_CATALOG_PRODUCT_INDEX_PRICE_CURRENCY;
ALTER TABLE `[prefix]_catalog_product_index_price` DROP `currency`;
ALTER TABLE `[prefix]_catalog_product_index_price` DROP FOREIGN KEY FK_CATALOG_PRODUCT_INDEX_PRICE_STORE;
...
ALTER TABLE `[prefix]_catalog_product_index_price_idx` DROP INDEX IDX_CATALOG_PRODUCT_INDEX_PRICE_IDX_CURRENCY;
ALTER TABLE `[prefix]_catalog_product_index_price_idx` DROP `currency`;
ALTER TABLE `[prefix]_catalog_product_index_price_idx` DROP FOREIGN KEY FK_CATALOG_PRODUCT_INDEX_PRICE_IDX_STORE;
...
ALTER TABLE `[prefix]_catalog_product_index_price_tmp` DROP INDEX IDX_CATALOG_PRODUCT_INDEX_PRICE_TMP_CURRENCY;
ALTER TABLE `[prefix]_catalog_product_index_price_tmp` DROP `currency`;
ALTER TABLE `[prefix]_catalog_product_index_price_tmp` DROP FOREIGN KEY FK_CATALOG_PRODUCT_INDEX_PRICE_TMP_STORE;
...
DELETE FROM `[prefix]_catalog_product_entity_tier_price` WHERE (`stock_id` IS NOT NULL) OR (`currency` IS NOT NULL) OR (`store_id` <> 0);
...
ALTER TABLE `[prefix]_catalog_product_entity_tier_price` DROP INDEX IDX_CATALOG_PRODUCT_ENTITY_TIER_PRICE_CURRENCY;
ALTER TABLE `[prefix]_catalog_product_entity_tier_price` DROP `currency`;
ALTER TABLE `[prefix]_catalog_product_entity_tier_price` DROP FOREIGN KEY FK_CATALOG_PRODUCT_ENTITY_TIER_PRICE_STORE;
...
ALTER TABLE `[prefix]_catalog_product_index_tier_price` DROP INDEX IDX_CATALOG_PRODUCT_INDEX_TIER_PRICE_CURRENCY;
ALTER TABLE `[prefix]_catalog_product_index_tier_price` DROP `currency`;
ALTER TABLE `[prefix]_catalog_product_index_tier_price` DROP FOREIGN KEY FK_CATALOG_PRODUCT_INDEX_TIER_PRICE_STORE;
...
DELETE FROM `[prefix]_core_resource` WHERE `code` = 'warehouseplus_setup';
